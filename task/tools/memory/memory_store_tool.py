...
class StoreMemoryTool(BaseTool):
    ...
    def description(self) -> str:
        return "Store important information about the user for long-term memory. Use this to save facts, preferences, personal details, goals, or context that should be remembered across conversations. Only store novel, meaningful information. Examples: user's location, job, preferences, family details, or important plans."
